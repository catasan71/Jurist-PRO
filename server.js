...
app.post(["/api/gemini", "/gemini"], async (req, res) => {
  ...
  try {
    ...
    if (errMsg.includes("API key not valid") || errMsg.includes("API_KEY_INVALID")) {
      ...
      errMsg = "Limita de cereri/minut a cheii API (Google Free Tier Quota) a fost temporar atins\u0103. V\u0103 rug\u0103m s\u0103 re\xEEncerca\u021Bi \xEEn 30-60 de secunde.";
    }
    if (res.headersSent) {
...
if (!import_process.default.env.VERCEL) {
